...
class Predictor(nn.Module):
    ...
    def forward(self, x, reverse=False, eta=0.1, p=0.25):
        if reverse:
...
class Predictor_dropout(nn.Module):
    def __init__(self, num_class=64, inc=4096, temp=0.05, p=0.25):
        super(Predictor_dropout, self).__init__()
...
class Predictor_dropout_deep(nn.Module):
    def __init__(self, num_class=64, inc=4096, p=0.25, temp=0.05):
        super(Predictor_dropout_deep, self).__init__()
        self.fc1 = nn.Linear(inc, 512)
        self.fc2 = nn.Linear(512, num_class, bias=False)
        self.num_class = num_class
        self.p = p
